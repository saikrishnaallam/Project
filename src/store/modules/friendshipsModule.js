// many things here were experimental it needs cleanup of unused things and some are moved to current user
// should be much cleaner and redone when connected to server
const state = {
